        ...
        eval: function (cmd, context, filename, callback) {
            var x = 0,
                ...
                if ((/\d,\d/).test(data) === true) {
                            ...
                            if (pos.toString().split("x").length < 3) {
                                ...
                                do {
                                    ...
                                    if (cc > 1 && pos[b][ce] === "") {
                                        pos[b][ce] = "o";
                                        board();
                                        console.log("I win on row " + (b + 1) + ", you loose!");
                                        process.exit(0);
                                    }
                                    b = b + 1;
                                } while (b < 3);
                                ...
                                do {
                                    ...
                                    if (cc > 1 && pos[ce][b] === "") {
                                        pos[ce][b] = "o";
                                        board();
                                        console.log("I win on column " + (b + 1) + ", you loose!");
                                        process.exit(0);
                                    }
                                    b = b + 1;
                                } while (b < 3);
                    ...
                    console.log("Please make your move by stating a line number and a column number from 1 to 3");
